...
router.post('/import', upload.single('file'), asyncHandler(TransactionController.import));
router.post(
  '/import/confirm',
...
router.patch('/:id', validate(updateTransactionSchema), asyncHandler(TransactionController.update));
